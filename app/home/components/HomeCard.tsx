...
function HomeCard() {
  return (
    <div className="w-64 h-80 flex flex-col gap-2 justify-center items-center overflow-hidden bg-white hover:shadow-xl shadow-slate-600 p-2 transition-all duration-500">
      ...
      <button className="py-2 w-fit mx-2 text-sm px-4 rounded-md text-slate-100 shadow-sm shadow-slate-300 bg-indigo-700 hover:scale-105 hover:bg-blue-700 transition-all duration-500">
        Solicitar
      </button>
    </div>
  );
